...
if (isset($_POST['submit'])) {
   ...
   if ($select->rowCount() > 0) {
      ...
      if ($pass != $cpass) {
         ...
         $otp = "108"; // Hardcoded for demonstration, replace with actual OTP verification
...
<body>
   ...
   <section class="form-container">
      ...
      <form action="" enctype="multipart/form-data" method="POST" style="background-color: lime;">
         ...
         <input type="submit" value="Register Now" class="btn" name="submit" style="background-color: white; color: black">
   ...
   <script>
      function sendOTP() {
         // Implement logic to send OTP to the provided contact number
